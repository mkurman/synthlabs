        ...
        <div className="bg-slate-900 border-b border-slate-800 p-4 space-y-4">
                ...
                {!isRunning ? (
                    ...
                    <>
                        <button
                            ...
                            className="bg-amber-600 hover:bg-amber-500 text-white py-2 px-4 rounded-lg font-medium text-sm flex items-center justify-center gap-2 shadow-lg shadow-amber-500/20 transition-all"
                        >
                        ...
                        <button
                            ...
                            className="bg-red-600 hover:bg-red-500 text-white py-2 px-4 rounded-lg font-medium text-sm flex items-center justify-center gap-2 shadow-lg shadow-red-500/20 transition-all"
                        >
            ...
            {!isRunning && invalidLogCount > 0 && (
                <button
                    ...
                    className="w-full py-2 px-3 bg-amber-950/30 border border-amber-500/20 hover:bg-amber-950/50 text-amber-500 rounded text-xs font-medium flex items-center justify-center gap-2 transition-colors"
                >
            ...
            {environment === Environment.Production && (
                <div className="flex items-center gap-2 py-2 px-3 bg-pink-950/20 border border-pink-500/20 rounded text-[10px] text-pink-300">
